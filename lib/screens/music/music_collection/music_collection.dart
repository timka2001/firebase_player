          ...
          child: StreamBuilder(
              ...
              builder: (context, snapshot) {
                return ListView.builder(
                    itemCount: information.audio_on_screen.artist.length + 1,
                    shrinkWrap: true,
                      ...
                      if (index == 0) {
                        ...
                        return Padding(
                          ...
                          child: customListTile(
                              ...
                              title:
                                  information.audio_on_screen.artist[index - 1],
                              single: information
                        ...
                        children: [
                          Slider.adaptive(
                              ...
                              max: information.playNow.duration.inSeconds
                                  .toDouble(),
                              value: information.playNow.position.inSeconds
                                  .toDouble(),
                              onChanged: (value) {}),
                          customListTileOn(
                              onTap: () {
                              ...
                              single: information.audio_on_screen
                                  .trackName[information.playNow.tapIndex],
                              cover: information.audio_on_screen
                                  .trackImage[information.playNow.tapIndex])
                        ],
                      ));
                } else {
                  return Text('');
